...
def train_model(model, criterion, dataloaders, optimizer, metrics, bpath, num_epochs=3):
    ...
    best_model_wts = copy.deepcopy(model.state_dict())  # 将最好的训练数据记录
    best_loss = 1e10  # 初始化参数
    best_f1_score = 0
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        # Create a dictionary to store the aggregated batch-wise loss and evaluation metrics:
